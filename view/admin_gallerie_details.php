...
// <a class="btn btn-info" href="' . $GLOBALS['appurl'] . '/picture/newPicture?gid=' . $gallerie->GID . '">Add Picture</a>
echo '
      <h2>#' . $gallerie->GID . '</h2>
      <h5>' . $gallerie->NAME . '</h5>
...
for($i=0; $i< count($pictures);$i++) {
    ...
    echo "</p></h5>";
    echo '<a class="btn btn-info" href="' . $GLOBALS['appurl'] . '/admin/AdminEditPicture?gid=' . $gallerie->GID . '&pid=' . $pictures[$i]->PID . '">Edit Picture</a>';
    echo '<a class="btn btn-info" href="' . $GLOBALS['appurl'] . '/admin/AdminDeletePicture?gid=' . $gallerie->GID . '&pid=' . $pictures[$i]->PID . '">Delete Picture</a>';
    echo "</div>";
